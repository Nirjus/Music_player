...
const songs = [
    ...
    <div class="subtitle">Un known</div>`,
...
let manu_side = document.getElementsByClassName('manu_side')[0];

menu_list_active_button.addEventListener('click', () => {
    manu_side.style.transform = "unset";
    menu_list_active_button.style.opacity = 0;
});
let song_side = document.getElementsByClassName('song_side')[0];
song_side.addEventListener('click', () => {
    if(window.innerWidth <850){
    manu_side.style.transform = "translateX(-100%)";
    }else{
        manu_side.style.transform = "translateX(0%)";
    }
